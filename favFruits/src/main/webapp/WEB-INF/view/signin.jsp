  ...
  <div class="flex-direction:column;" >
	  <form action="Login" method="post">
		<div style="text-align:center;" class="text-cenr mb-4 ">
		  <img src="/favFruits/images/fruitslogo2.gif" class="rounded mb-4" alt="logo" width="72" height="72" style="">
		  <h1 style="font-family: 'Caveat Brush', cursive">Fruits Ranking</h1>
		</div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" inJZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
